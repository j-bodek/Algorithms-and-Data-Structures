...
newBinaryTree = binaryTree('maxValueHouse(0)')
newBinaryTree.insert('maxValueHouse(2)')
newBinaryTree.insert('maxValueHouse(1)')
newBinaryTree.insert('maxValueHouse(4)')
newBinaryTree.insert('maxValueHouse(3)')
newBinaryTree.insert('maxValueHouse(3)')
newBinaryTree.insert('maxValueHouse(2)')
